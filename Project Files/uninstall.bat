...
echo.
echo   1. Remove Application & Environment ONLY (Keeps portable Python)
echo   2. Remove EVERYTHING (Application, Environment, AND portable Python)
...
echo and shortcuts. The portable Python installation will be kept.
echo.
